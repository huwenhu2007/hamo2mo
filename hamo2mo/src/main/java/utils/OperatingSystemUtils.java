...
public class OperatingSystemUtils {
	...
	static class OperatingSystemUtilsInside{
		private static final OperatingSystemUtils operatingSystemUtils = new OperatingSystemUtils();
	}

	public static OperatingSystemUtils getInstance(){
		return OperatingSystemUtilsInside.operatingSystemUtils;
	}
